<?php
/**
 *  Theme Star Portfolio Post Type
 *
 * @package    Theme Star Portfolio_Post_Type
 * @author    Tuan Anh Le
 * @license   GPL-2.0+
 * @link      http://themestar.com/
 * @copyright 2016 Tuan Anh Le
 *
 * @wordpress-plugin
 * Plugin Name: Theme Star Portfolio Post Type
 * Plugin URI:  https://themestar.co.uk/
 * Description: Enables a portfolio post type and taxonomies.
 * Version:     1.0
 * Author:      Tuan Anh Le
 * Author URI:  http://themestar.co.uk/
